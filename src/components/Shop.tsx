        ...
        <div data-aos='fade-up' className='flex flex-wrap justify-center items-center mt-20 ml-9 mr-9'>
            <div className='w-[45%] flex justify-center items-center'>
                <div>
                    ...
                    <button className='border-2 p-3 bg-dark-blue border-dark-blue cursor-pointer text-white hover:text-blue-900 hover:font-bold hover:bg-white'>Shop the watch</button>
                </div>
            </div>
            <div>
                <img src="../shop.avif" alt="watch images" className='w-180 p-10' />
            </div>
        </div>
    )
}
